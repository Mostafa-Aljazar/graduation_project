...
import {
  AdBlogStory,
  AdBlogStoryResponse,
  AdsBlogsStoriesResponse,
} from '@/@types/actors/manager/ads-blogs-stories/adsBlogsStoriesResponse.type';
import { getAdBlogStoryProps } from '@/actions/actors/manager/blog-stories-ads/getAdBlogStory';
import { getAdsBlogsStoriesProps } from '@/actions/actors/manager/blog-stories-ads/getAdsBlogsStories';
import {
  HOME_HERO_SLIDER_1,
  HOME_HERO_SLIDER_2,
  HOME_HERO_SLIDER_3,
...
export const fakeAds: AdBlogStory[] = [
  {
    id: 1,
    imgs: [
  ...
  },
  {
    ...
    `,
    created_at: new Date('2025-05-22T14:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
    type: TYPE_WRITTEN_CONTENT.ADS,
  },
  {
    ...
    `,
    created_at: new Date('2025-05-24T06:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
    type: TYPE_WRITTEN_CONTENT.ADS,
  },
  {
    ...
    `,
    created_at: new Date('2025-05-23T09:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
    type: TYPE_WRITTEN_CONTENT.ADS,
  },
  {
    ...
    `,
    created_at: new Date('2025-05-26T12:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
    type: TYPE_WRITTEN_CONTENT.ADS,
  },
  {
    ...
    `,
    created_at: new Date('2025-05-26T15:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
    type: TYPE_WRITTEN_CONTENT.ADS,
  },
  {
...
export const fakeBlogs: AdBlogStory[] = [
  {
    id: 1,
    ...
    `,
    imgs: [HOME_HERO_SLIDER_2.src, HOME_HERO_SLIDER_3.src],
  ...
  },
  {
    ...
    `,
    imgs: [HOME_HERO_SLIDER_1.src, HOME_HERO_SLIDER_2.src],
  ...
  },
  {
    ...
    `,
    imgs: [HOME_HERO_SLIDER_1.src, HOME_HERO_SLIDER_3.src],
  ...
  },
  {
    ...
    `,
    imgs: [HOME_HERO_SLIDER_3.src, HOME_HERO_SLIDER_1.src],
    created_at: new Date('2025-05-20T11:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
    type: TYPE_WRITTEN_CONTENT.BLOG,
  },
  {
  ...
  },
  {
    ...
    imgs: [HOME_HERO_SLIDER_3.src, HOME_HERO_SLIDER_1.src],
    created_at: new Date('2025-05-29T14:00:00Z'),
    updated_at: new Date('2025-05-29T16:00:00Z'),
    type: TYPE_WRITTEN_CONTENT.BLOG,
  },
  {
    id: 9,
    ...
    updated_at: new Date('2025-05-30T15:00:00Z'),
    type: TYPE_WRITTEN_CONTENT.BLOG,
  },
  {
    id: 10,
    ...
    updated_at: new Date('2025-06-01T16:00:00Z'),
    type: TYPE_WRITTEN_CONTENT.BLOG,
  },
];

export const fakeStories: AdBlogStory[] = [
  {
    id: 1,
    imgs: [HOME_HERO_SLIDER_1.src],
  ...
  },
  {
    ...
    created_at: new Date('2023-10-15T14:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
  ...
  },
  {
    ...
    created_at: new Date('2023-12-05T13:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
  ...
  },
  {
    ...
    created_at: new Date('2024-06-20T14:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
  ...
  },
  {
    ...
    created_at: new Date('2024-08-12T09:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
  ...
  },
  {
    ...
    created_at: new Date('2024-10-05T12:00:00Z'),
    updated_at: new Date('2025-05-26T15:06:00Z'),
...
export const fakeWrittenContentResponse = ({
  id,
  type,
}: getAdBlogStoryProps): AdBlogStoryResponse => {
  ...
  const filteredSpecific = selectedWrittenContents.find(
    (item) => item.id == id
  );
  ...
  if (filteredSpecific) {
    return {
      ...
      ad_blog_story: filteredSpecific as AdBlogStory,
      error: undefined,
    };
  }
  ...
  return {
    status: 404,
    message: 'تم جلب بيانات المحتوى بنجاح',
    ad_blog_story: {
      id: -1,
      title: '',
      brief: '',
...
export const fakeWrittenContentsResponse = ({
  ...
  limit = 10,
  type,
}: getAdsBlogsStoriesProps): AdsBlogsStoriesResponse => {
  const selectedWrittenContents =
    type == TYPE_WRITTEN_CONTENT.ADS
      ? fakeAds
      : type == TYPE_WRITTEN_CONTENT.BLOG
  ...
  const fakeResponse: AdsBlogsStoriesResponse = {
    status: 200,
    ads_blogs_stories: paginatedAids,
