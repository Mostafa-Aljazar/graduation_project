...
export const fakeAds: AdBlogStory[] = [
  {
    id: 1,
    imgs: [HOME_HERO_SLIDER_1, HOME_HERO_SLIDER_2, HOME_HERO_SLIDER_3],
...
export const fakeBlogs: AdBlogStory[] = [
  {
    ...
    `,
    imgs: [HOME_HERO_SLIDER_2, HOME_HERO_SLIDER_3],
  ...
  },
  {
    ...
    `,
    imgs: [HOME_HERO_SLIDER_1, HOME_HERO_SLIDER_2],
  ...
  },
  {
    ...
    `,
    imgs: [HOME_HERO_SLIDER_1, HOME_HERO_SLIDER_3],
  ...
  },
  {
    ...
    `,
    imgs: [HOME_HERO_SLIDER_3, HOME_HERO_SLIDER_1],
